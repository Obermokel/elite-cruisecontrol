...
public class CruiseControlFrame extends JFrame implements WindowListener, KeyListener, DebugImageListener, JournalUpdateListener, StatusUpdateListener {
	...
	@Override
	public void onNewDebugImage(BufferedImage debugImage, GrayF32 orangeHudImage, GrayF32 yellowHudImage, GrayF32 blueWhiteHudImage, GrayF32 redHudImage, GrayF32 brightImage) {
		this.debugPanel.updateScreenCapture(debugImage, orangeHudImage, yellowHudImage, blueWhiteHudImage, redHudImage, brightImage);
	}
