...
public class ShipControl {
	...
	public void setPitchUp(int percent) {
		if (percent < 0) {
			...
			this.pitchUp = "Larissa DeLorean".equals(CruiseControlApplication.myCommanderName) ? Math.round(0.60f * percent) : percent; // FIXME Dirty hack for Larissa
	...
	public void setPitchDown(int percent) {
		if (percent < 0) {
			...
			this.pitchDown = "Larissa DeLorean".equals(CruiseControlApplication.myCommanderName) ? Math.round(0.60f * percent) : percent; // FIXME Dirty hack for Larissa
